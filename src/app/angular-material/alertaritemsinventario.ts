...
@Component({
  ...
  <table mat-table [dataSource]="items" class="mat-elevation-z8 col-12">
      ...
      <ng-container matColumnDef="codigocontable">
        <th mat-header-cell *matHeaderCellDef>codigocontable</th>
        <td mat-cell *matCellDef="let element">{{ element.codigoContable }}</td>
      </ng-container>
